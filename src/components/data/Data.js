export const beers = [
    ...
    { id: 5, beerName: 'DeEssoCiTratta', beerStyle: 'APA', price: 3, available: true },
    { id: 6, beerName: 'Santa APA', beerStyle: 'APA', price: 3, available: true },
    { id: 7, beerName: 'German', beerStyle: 'Pilsen', price: 1, available: true },
    { id: 8, beerName: 'London Porter', beerStyle: 'Porter', price: 2, available: false },
    { id: 9, beerName: 'Scotish ALE', beerStyle: 'Red', price: 5, available: false },
];